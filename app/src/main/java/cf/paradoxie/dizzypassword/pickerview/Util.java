...
public class Util {
     ...
     */
    public static void alertTimerPicker(View v,Context context, TimePickerView.Type type, final String format, final TimerPickerCallBack callBack) {
     ...
     * @param click
     */
    public static void alertBottomWheelOption(View v,Context context, ArrayList<?> list, final OnWheelViewClick click) {
